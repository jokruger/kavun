...
const (
	...
	OpGetBuiltinFunction  = Opcode(34) // Get builtin function
	...
	OpImportBuiltinModule = Opcode(49) // Import builtin module by static ID
	// 50...255 are reserved for future use
)
...
var OpcodeOperands = [...][]int{
	...
	OpImportBuiltinModule: {1},    // module static ID
}
