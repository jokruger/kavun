...
- in test review and rewrite all tests commented out with "REDO"
- in bytecode add section to store compiled functions generated by compiler (user modules compiled to functions)
- add new opcode to load compiled function Value to stack from bytecode section
- stdlib wrapError
- remove static constructors (except basic types)
