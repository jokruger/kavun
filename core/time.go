...
func timeTypeMethodCall(v Value, vm VM, name string, args []Value) (Value, error) {
	...
	case "to_time":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_time", "0", len(args))
		}
		return v, nil

	case "to_bool":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_bool", "0", len(args))
		}
	...
	case "to_int":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_int", "0", len(args))
		}
		i, _ := timeTypeAsInt(v)
	...
	case "to_string":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_string", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "year":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.year", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "month":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.month", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "day":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.day", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "hour":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.hour", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "minute":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.minute", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "second":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.second", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "nanosecond":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.nanosecond", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "unix":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.unix", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "unix_nano":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.unix_nano", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "week_day":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.week_day", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "year_day":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.year_day", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "month_name":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.month_name", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "week_day_name":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.week_day_name", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "to_utc":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_utc", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "to_local":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_local", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "to_date_string":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_date_string", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "to_time_string":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_time_string", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "to_date_time_string":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_date_time_string", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
	...
	case "zone_offset":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.zone_offset", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
		_, offset := o.Zone()
	...
	case "zone_name":
		if len(args) != 0 {
			return UndefinedValue(), errs.NewWrongNumArgumentsError("time.zone_name", "0", len(args))
		}
		o := (*time.Time)(v.Ptr)
		name, _ := o.Zone()
