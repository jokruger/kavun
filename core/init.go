...
func init() {
	...
	setValueType(VT_UNDEFINED, ValueType{
		...
		IsTrue:       hook.ReturnConst[Value, bool](false), // undefined is always false
		IsIterable:   hook.ReturnConst[Value, bool](true),
	...
	setValueType(VT_BUILTIN_FUNCTION, ValueType{
		...
		IsTrue:       hook.ReturnConst[Value, bool](true),
		IsCallable:   hook.ReturnConst[Value, bool](true),
	...
	setValueType(VT_ERROR, ValueType{
		...
		IsTrue:       hook.ReturnConst[Value, bool](false), // error is always false
	...
	setValueType(VT_BOOL, ValueType{
		...
		Len:          hook.ReturnConst[Value, int64](1),
