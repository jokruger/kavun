...
const (
	Constant            = Opcode(0)  // Load constant
	...
	Format              = Opcode(45) // Format value with pre-parsed FormatSpec constant
	...
	DeferMethod         = Opcode(48) // Register deferred method call: pop receiver + N args; method name from constants[methodIdx]
