...
func init() {
	...
	InitModule("text", module.Text, nil, map[uint64]*core.BuiltinFunction{
		0:  core.NewBuiltinFunction("re_match", textREMatch, 2, false, true),               // re_match(pattern, text) => bool/error
		1:  core.NewBuiltinFunction("re_find", textREFind, 2, true, true),                  // re_find(pattern, text [,count]) => [[{text:,begin:,end:}]]/undefined
		2:  core.NewBuiltinFunction("re_replace", textREReplace, 3, false, true),           // re_replace(pattern, text, repl) => string/error
		3:  core.NewBuiltinFunction("re_split", textRESplit, 2, true, true),                // re_split(pattern, text [,count]) => [string]/error
		4:  core.NewBuiltinFunction("re_compile", textRECompile, 1, false, true),           // re_compile(pattern) => Regexp/error
		5:  core.NewBuiltinFunction("compare", stringsCompare, 2, false, true),             // compare(a, b) => int
		6:  core.NewBuiltinFunction("contains", textContains, 2, false, true),              // contains(s, substr) => bool
		7:  core.NewBuiltinFunction("contains_any", textContainsAny, 2, false, true),       // contains_any(s, chars) => bool
		8:  core.NewBuiltinFunction("count", stringsCount, 2, false, true),                 // count(s, substr) => int
		9:  core.NewBuiltinFunction("equal_fold", textEqualFold, 2, false, true),           // "equal_fold(s, t) => bool
		10: core.NewBuiltinFunction("fields", stringsFields, 1, false, true),               // fields(s) => [string]
		11: core.NewBuiltinFunction("has_prefix", textHasPrefix, 2, false, true),           // has_prefix(s, prefix) => bool
		12: core.NewBuiltinFunction("has_suffix", textHasSuffix, 2, false, true),           // has_suffix(s, suffix) => bool
		13: core.NewBuiltinFunction("index", stringsIndex, 2, false, true),                 // index(s, substr) => int
		14: core.NewBuiltinFunction("index_any", stringsIndexAny, 2, false, true),          // index_any(s, chars) => int
		15: core.NewBuiltinFunction("join", textJoin, 2, false, true),                      // join(arr, sep) => string
		16: core.NewBuiltinFunction("last_index", stringsLastIndex, 2, false, true),        // last_index(s, substr) => int
		17: core.NewBuiltinFunction("last_index_any", stringsLastIndexAny, 2, false, true), // last_index_any(s, chars) => int
		18: core.NewBuiltinFunction("repeat", textRepeat, 2, false, true),                  // repeat(s, count) => string
		19: core.NewBuiltinFunction("replace", textReplace, 4, false, true),                // replace(s, old, new, n) => string
		20: core.NewBuiltinFunction("substr", textSubstring, 2, true, true),                // substr(s, lower [,upper]) => string
		21: core.NewBuiltinFunction("split", stringsSplit, 2, false, true),                 // split(s, sep) => [string]
		22: core.NewBuiltinFunction("split_after", stringsSplitAfter, 2, false, true),      // split_after(s, sep) => [string]
		23: core.NewBuiltinFunction("split_after_n", stringsSplitAfterN, 3, false, true),   // split_after_n(s, sep, n) => [string]
		24: core.NewBuiltinFunction("split_n", stringsSplitN, 3, false, true),              // split_n(s, sep, n) => [string]
		25: core.NewBuiltinFunction("title", stringsTitle, 1, false, true),                 // title(s) => string
		26: core.NewBuiltinFunction("to_lower", stringsToLower, 1, false, true),            // to_lower(s) => string
		27: core.NewBuiltinFunction("to_title", stringsToTitle, 1, false, true),            // to_title(s) => string
		28: core.NewBuiltinFunction("to_upper", stringsToUpper, 1, false, true),            // to_upper(s) => string
		29: core.NewBuiltinFunction("pad_left", textPadLeft, 2, true, true),                // pad_left(s, pad_len [,pad_with]) => string
		30: core.NewBuiltinFunction("pad_right", textPadRight, 2, true, true),              // pad_right(s, pad_len [,pad_with]) => string
		31: core.NewBuiltinFunction("trim", stringsTrim, 2, false, true),                   // trim(s, cutset) => string
		32: core.NewBuiltinFunction("trim_left", stringsTrimLeft, 2, false, true),          // trim_left(s, cutset) => string
		33: core.NewBuiltinFunction("trim_prefix", stringsTrimPrefix, 2, false, true),      // trim_prefix(s, prefix) => string
		34: core.NewBuiltinFunction("trim_right", stringsTrimRight, 2, false, true),        // trim_right(s, cutset) => string
		35: core.NewBuiltinFunction("trim_space", stringsTrimSpace, 1, false, true),        // trim_space(s) => string
		36: core.NewBuiltinFunction("trim_suffix", stringsTrimSuffix, 2, false, true),      // trim_suffix(s, suffix) => string
		37: core.NewBuiltinFunction("atoi", strconvAtoi, 1, false, true),                   // atoi(str) => int/error
		38: core.NewBuiltinFunction("format_bool", textFormatBool, 1, false, true),         // format_bool(b) => string
		39: core.NewBuiltinFunction("format_float", textFormatFloat, 4, false, true),       // format_float(f, fmt, prec, bits) => string
		40: core.NewBuiltinFunction("format_int", textFormatInt, 2, false, true),           // format_int(i, base) => string
		41: core.NewBuiltinFunction("itoa", strconvItoa, 1, false, true),                   // itoa(i) => string
		42: core.NewBuiltinFunction("parse_bool", textParseBool, 1, false, true),           // parse_bool(str) => bool/error
		43: core.NewBuiltinFunction("parse_float", textParseFloat, 2, false, true),         // parse_float(str, bits) => float/error
		44: core.NewBuiltinFunction("parse_int", textParseInt, 3, false, true),             // parse_int(str, base, bits) => int/error
		45: core.NewBuiltinFunction("quote", strconvQuote, 1, false, true),                 // quote(str) => string
		46: core.NewBuiltinFunction("unquote", strconvUnquote, 1, false, true),             // unquote(str) => string/error
	})
}
