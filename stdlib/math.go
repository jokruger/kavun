...
func mathSignbit(args ...core.Object) (ret core.Object, err error) {
	...
	if !ok {
		return nil, gse.ErrInvalidArgumentType{Name: "first", Expected: "float(compatible)", Found: args[0].TypeName()}
	}
	if math.Signbit(f1) {
...
func mathYn(args ...core.Object) (ret core.Object, err error) {
	...
	if !ok {
		return nil, gse.ErrInvalidArgumentType{Name: "second", Expected: "float(compatible)", Found: args[1].TypeName()}
	}
