...
func osChmod(vm core.VM, args []core.Value) (core.Value, error) {
	...
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chmod", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chmod", "second", "int(compatible)", args[1].TypeName())
	}
...
func osMkdir(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.mkdir", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.mkdir", "second", "int(compatible)", args[1].TypeName())
	}
...
func osMkdirAll(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.mkdir_all", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.mkdir_all", "second", "int(compatible)", args[1].TypeName())
	}
...
func osLchown(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.lchown", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.lchown", "second", "int(compatible)", args[1].TypeName())
	}
	i3, ok := args[2].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.lchown", "third", "int(compatible)", args[2].TypeName())
	}
...
func osChown(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chown", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chown", "second", "int(compatible)", args[1].TypeName())
	}
	i3, ok := args[2].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chown", "third", "int(compatible)", args[2].TypeName())
	}
...
func osTruncate(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.truncate", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.truncate", "second", "int(compatible)", args[1].TypeName())
	}
...
func osSymlink(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.symlink", "first", "string(compatible)", args[0].TypeName())
	}
	s2, ok := args[1].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.symlink", "second", "string(compatible)", args[1].TypeName())
	}
...
func osSetenv(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.set_env", "first", "string(compatible)", args[0].TypeName())
	}
	s2, ok := args[1].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.set_env", "second", "string(compatible)", args[1].TypeName())
	}
...
func osRename(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.rename", "first", "string(compatible)", args[0].TypeName())
	}
	s2, ok := args[1].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.rename", "second", "string(compatible)", args[1].TypeName())
	}
...
func osLink(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.link", "first", "string(compatible)", args[0].TypeName())
	}
	s2, ok := args[1].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.link", "second", "string(compatible)", args[1].TypeName())
	}
...
func osUnsetenv(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.unset_env", "first", "string(compatible)", args[0].TypeName())
	}
...
func osRemoveAll(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.remove_all", "first", "string(compatible)", args[0].TypeName())
	}
...
func osRemove(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.remove", "first", "string(compatible)", args[0].TypeName())
	}
...
func osChdir(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.chdir", "first", "string(compatible)", args[0].TypeName())
	}
...
func execLookPath(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.exec_look_path", "first", "string(compatible)", args[0].TypeName())
	}
	...
	if len(res) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.exec_look_path")
	}
...
func osReadlink(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.read_link", "first", "string(compatible)", args[0].TypeName())
	}
	...
	if len(res) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.read_link")
	}
	return vm.Allocator().NewStringValue(res), nil
}
...
func osGetenv(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.get_env", "first", "string(compatible)", args[0].TypeName())
	}
	s := os.Getenv(s1)
	if len(s) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.get_env")
	}
...
func osExit(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	i1, ok := args[0].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.exit", "first", "int(compatible)", args[0].TypeName())
	}
	os.Exit(int(i1))
...
func osEnviron(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	for _, elem := range env {
		if len(elem) > core.MaxStringLen {
			return core.UndefinedValue(), core.NewStringLimitError("os.environ")
		}
...
func osHostname(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	if len(res) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.hostname")
	}
	return vm.Allocator().NewStringValue(res), nil
}
...
func osGetwd(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	if len(res) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.get_wd")
	}
	return vm.Allocator().NewStringValue(res), nil
}
...
func osTempDir(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	s := os.TempDir()
	if len(s) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.temp_dir")
	}
	return vm.Allocator().NewStringValue(s), nil
}
...
func osReadFile(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.read_file", "first", "string(compatible)", args[0].TypeName())
	}
	...
	if len(bytes) > core.MaxBytesLen {
		return core.UndefinedValue(), core.NewBytesLimitError("os.read_file")
	}
...
func osStat(vm core.VM, args []core.Value) (ret core.Value, err error) {
	...
	fname, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.stat", "first", "string(compatible)", args[0].TypeName())
	}
	...
	fstat.SetKey("directory", core.BoolValue(stat.IsDir()))
...
func osCreate(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.create", "first", "string(compatible)", args[0].TypeName())
	}
...
func osOpen(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.open", "first", "string(compatible)", args[0].TypeName())
	}
	res, err := os.Open(s1)
	if err != nil {
		return wrapError(vm, err), nil
...
func osOpenFile(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.open_file", "first", "string(compatible)", args[0].TypeName())
	}
	i2, ok := args[1].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.open_file", "second", "int(compatible)", args[1].TypeName())
	}
	i3, ok := args[2].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.open_file", "third", "int(compatible)", args[2].TypeName())
	}
...
func osArgs(vm core.VM, args []core.Value) (core.Value, error) {
	...
	for _, osArg := range os.Args {
		if len(osArg) > core.MaxStringLen {
			return core.UndefinedValue(), core.NewStringLimitError("os.args")
		}
...
func osLookupEnv(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.lookup_env", "first", "string(compatible)", args[0].TypeName())
	}
	...
	if len(res) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.lookup_env")
	}
	return vm.Allocator().NewStringValue(res), nil
}
...
func osExpandEnv(vm core.VM, args []core.Value) (core.Value, error) {
	...
	s1, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.expand_env", "first", "string(compatible)", args[0].TypeName())
	}
	var vlen int
	var failed bool
	...
	if failed || len(s) > core.MaxStringLen {
		return core.UndefinedValue(), core.NewStringLimitError("os.expand_env")
	}
	return vm.Allocator().NewStringValue(s), nil
}
...
func osExec(vm core.VM, args []core.Value) (core.Value, error) {
	...
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.exec", "first", "string(compatible)", args[0].TypeName())
	}
	var execArgs []string
	for idx, arg := range args[1:] {
		execArg, ok := arg.AsString()
		if !ok {
			return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.exec", fmt.Sprintf("args[%d]", idx), "string(compatible)", arg.TypeName())
		}
...
func osFindProcess(vm core.VM, args []core.Value) (core.Value, error) {
	...
	i1, ok := args[0].AsInt()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.find_process", "first", "int(compatible)", args[0].TypeName())
	}
...
func osStartProcess(vm core.VM, args []core.Value) (core.Value, error) {
	...
	name, ok := args[0].AsString()
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.start_process", "first", "string(compatible)", args[0].TypeName())
	}
	var argv []string
	var err error
	if !args[1].IsArray() {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.start_process", "second", "array(string)", args[1].TypeName())
	}
	...
	if !ok {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.start_process", "third", "string(compatible)", args[2].TypeName())
	}

	var env []string
	if !args[3].IsArray() {
		return core.UndefinedValue(), core.NewInvalidArgumentTypeError("os.start_process", "fourth", "array(string)", args[3].TypeName())
	}
